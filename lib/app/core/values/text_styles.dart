...
TextStyle textStyleHeading2(BuildContext context) =>
    Theme.of(context).textTheme.displayMedium!;

TextStyle textStyleBody1(BuildContext context) =>
    Theme.of(context).textTheme.bodyLarge!;

TextStyle textStyleBody2(BuildContext context) =>
...
TextStyle textStyleInputTitleSmall(BuildContext context) =>
    Theme.of(context).textTheme.titleSmall!;
